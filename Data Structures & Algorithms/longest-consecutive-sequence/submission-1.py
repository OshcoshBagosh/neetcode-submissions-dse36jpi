class Solution:
    def longestConsecutive(self, nums: List[int]) -> int:
        ...
        We can save time by finding the number that starts each 
        sequence

        Then we can create a list of consecutive nums for each
        sequence starter

        Then return the length of the longest list
        """
